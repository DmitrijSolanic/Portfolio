...
, AVG("Close")
, ROUND(AVG(yoy_1),4) as yoy_1_avg
, ROUND(AVG(yoy_2),4) as yoy_2_avg
, ROUND(AVG(yoy_3),4) as yoy_3_avg
, ROUND(AVG(yoy_4),4) as yoy_4_avg
, ROUND(AVG(yoy_5),4) as yoy_5_avg
, ROUND(AVG(yoy_6),4) as yoy_6_avg
, ROUND(AVG(yoy_7),4) as yoy_7_avg
, ROUND(AVG(yoy_8),4) as yoy_8_avg
, ROUND(AVG(yoy_9),4) as yoy_9_avg
, ROUND(AVG(yoy_10),4) as yoy_10_avg
, ROUND(AVG(yoy_11),4) as yoy_11_avg
, ROUND(AVG(yoy_12),4) as yoy_12_avg
, ROUND(AVG(yoy_13),4) as yoy_13_avg
, ROUND(AVG(yoy_14),4) as yoy_14_avg
, ROUND(AVG(yoy_15),4) as yoy_15_avg
, ROUND(AVG(cpi),4) as cpi_avg
, ROUND(AVG(cpi_2y),4) as cpi_2y_avg
, ROUND(AVG(cpi_3y),4) as cpi_3y_avg
, ROUND(AVG(cpi_4y),4) as cpi_4y_avg
, ROUND(AVG(cpi_5y),4) as cpi_5y_avg
, ROUND(AVG(cpi_6y),4) as cpi_6y_avg
, ROUND(AVG(cpi_7y),4) as cpi_7y_avg
, ROUND(AVG(cpi_8y),4) as cpi_8y_avg
, ROUND(AVG(cpi_9y),4) as cpi_9y_avg
, ROUND(AVG(cpi_10y),4) as cpi_10y_avg
, ROUND(AVG(cpi_11y),4) as cpi_11y_avg
, ROUND(AVG(cpi_12y),4) as cpi_12y_avg
, ROUND(AVG(cpi_13y),4) as cpi_13y_avg
, ROUND(AVG(cpi_14y),4) as cpi_14y_avg
, ROUND(AVG(cpi_15y),4) as cpi_15y_avg
...
SELECT
ypo.*
,CASE WHEN yoy_1_avg > 0 THEN 1 
	   WHEN yoy_1_avg IS NULL THEN NULL
	   ELSE 0 END AS yoy_1_profit_years
, CASE WHEN yoy_2_avg > 0 THEN 1 
	   WHEN yoy_2_avg IS NULL THEN NULL
	   ELSE 0 END AS yoy_2_profit_years
, CASE WHEN yoy_3_avg > 0 THEN 1 
	   WHEN yoy_3_avg IS NULL THEN NULL
	   ELSE 0 END AS yoy_3_profit_years
, CASE WHEN yoy_4_avg > 0 THEN 1 
	   WHEN yoy_4_avg IS NULL THEN NULL
	   ELSE 0 END AS yoy_4_profit_years
, CASE WHEN yoy_5_avg > 0 THEN 1 
	   WHEN yoy_5_avg IS NULL THEN NULL
	   ELSE 0 END AS yoy_5_profit_years
, CASE WHEN yoy_6_avg > 0 THEN 1 
	   WHEN yoy_6_avg IS NULL THEN NULL
	   ELSE 0 END AS yoy_6_profit_years
, CASE WHEN yoy_7_avg > 0 THEN 1 
	   WHEN yoy_7_avg IS NULL THEN NULL
	   ELSE 0 END AS yoy_7_profit_years
, CASE WHEN yoy_8_avg > 0 THEN 1 
	   WHEN yoy_8_avg IS NULL THEN NULL
	   ELSE 0 END AS yoy_8_profit_years
, CASE WHEN yoy_9_avg > 0 THEN 1 
	   WHEN yoy_9_avg IS NULL THEN NULL
	   ELSE 0 END AS yoy_9_profit_years
, CASE WHEN yoy_10_avg > 0 THEN 1 
	   WHEN yoy_10_avg IS NULL THEN NULL
	   ELSE 0 END AS yoy_10_profit_years
, CASE WHEN yoy_11_avg > 0 THEN 1 
	   WHEN yoy_11_avg IS NULL THEN NULL
	   ELSE 0 END AS yoy_11_profit_years
, CASE WHEN yoy_12_avg > 0 THEN 1 
	   WHEN yoy_12_avg IS NULL THEN NULL
	   ELSE 0 END AS yoy_12_profit_years
, CASE WHEN yoy_13_avg > 0 THEN 1 
	   WHEN yoy_13_avg IS NULL THEN NULL
	   ELSE 0 END AS yoy_13_profit_years
, CASE WHEN yoy_14_avg > 0 THEN 1 
	   WHEN yoy_14_avg IS NULL THEN NULL
	   ELSE 0 END AS yoy_14_profit_years
, CASE WHEN yoy_15_avg > 0 THEN 1 
	   WHEN yoy_15_avg IS NULL THEN NULL
	   ELSE 0 END AS yoy_15_profit_years
, ROUND(yoy_1_avg - (cpi_avg	-1) ,4) as real_yoy_1_avg
, ROUND(yoy_2_avg - (cpi_2y_avg	-1) ,4) as real_yoy_2_avg
, ROUND(yoy_3_avg - (cpi_3y_avg	-1) ,4) as real_yoy_3_avg
, ROUND(yoy_4_avg - (cpi_4y_avg	-1) ,4) as real_yoy_4_avg
, ROUND(yoy_5_avg - (cpi_5y_avg	-1) ,4) as real_yoy_5_avg
, ROUND(yoy_6_avg - (cpi_6y_avg	-1) ,4) as real_yoy_6_avg
, ROUND(yoy_7_avg - (cpi_7y_avg	-1) ,4) as real_yoy_7_avg
, ROUND(yoy_8_avg - (cpi_8y_avg	-1) ,4) as real_yoy_8_avg
, ROUND(yoy_9_avg - (cpi_9y_avg	-1) ,4) as real_yoy_9_avg
, ROUND(yoy_10_avg - (cpi_10y_avg -1) ,4) as real_yoy_10_avg
, ROUND(yoy_11_avg - (cpi_11y_avg -1) ,4) as real_yoy_11_avg
, ROUND(yoy_12_avg - (cpi_12y_avg -1) ,4) as real_yoy_12_avg
, ROUND(yoy_13_avg - (cpi_13y_avg -1) ,4) as real_yoy_13_avg
, ROUND(yoy_14_avg - (cpi_14y_avg -1) ,4) as real_yoy_14_avg
, ROUND(yoy_15_avg - (cpi_15y_avg -1) ,4) as real_yoy_15_avg
...
SELECT
ypt.*
, CASE WHEN real_yoy_1_avg > 0 THEN 1 
	   WHEN real_yoy_1_avg IS NULL THEN NULL
	   ELSE 0 END AS real_yoy_1_profit_years
, CASE WHEN real_yoy_2_avg > 0 THEN 1 
	   WHEN real_yoy_2_avg IS NULL THEN NULL
	   ELSE 0 END AS real_yoy_2_profit_years
, CASE WHEN real_yoy_3_avg > 0 THEN 1 
	   WHEN real_yoy_3_avg IS NULL THEN NULL
	   ELSE 0 END AS real_yoy_3_profit_years
, CASE WHEN real_yoy_4_avg > 0 THEN 1 
	   WHEN real_yoy_4_avg IS NULL THEN NULL
	   ELSE 0 END AS real_yoy_4_profit_years
, CASE WHEN real_yoy_5_avg > 0 THEN 1 
	   WHEN real_yoy_5_avg IS NULL THEN NULL
	   ELSE 0 END AS real_yoy_5_profit_years
, CASE WHEN real_yoy_6_avg > 0 THEN 1 
	   WHEN real_yoy_6_avg IS NULL THEN NULL
	   ELSE 0 END AS real_yoy_6_profit_years
, CASE WHEN real_yoy_7_avg > 0 THEN 1 
	   WHEN real_yoy_7_avg IS NULL THEN NULL
	   ELSE 0 END AS real_yoy_7_profit_years
, CASE WHEN real_yoy_8_avg > 0 THEN 1 
	   WHEN real_yoy_8_avg IS NULL THEN NULL
	   ELSE 0 END AS real_yoy_8_profit_years
, CASE WHEN real_yoy_9_avg > 0 THEN 1 
	   WHEN real_yoy_9_avg IS NULL THEN NULL
	   ELSE 0 END AS real_yoy_9_profit_years
, CASE WHEN real_yoy_10_avg > 0 THEN 1 
	   WHEN real_yoy_10_avg IS NULL THEN NULL
	   ELSE 0 END AS real_yoy_10_profit_years
, CASE WHEN real_yoy_11_avg > 0 THEN 1 
	   WHEN real_yoy_11_avg IS NULL THEN NULL
	   ELSE 0 END AS real_yoy_11_profit_years
, CASE WHEN real_yoy_12_avg > 0 THEN 1 
	   WHEN real_yoy_12_avg IS NULL THEN NULL
	   ELSE 0 END AS real_yoy_12_profit_years
, CASE WHEN real_yoy_13_avg > 0 THEN 1 
	   WHEN real_yoy_13_avg IS NULL THEN NULL
	   ELSE 0 END AS real_yoy_13_profit_years
, CASE WHEN real_yoy_14_avg > 0 THEN 1 
	   WHEN real_yoy_14_avg IS NULL THEN NULL
	   ELSE 0 END AS real_yoy_14_profit_years
, CASE WHEN real_yoy_15_avg > 0 THEN 1 
	   WHEN real_yoy_15_avg IS NULL THEN NULL
...
SELECT
    *
    , CASE WHEN yoy_1_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY grp1 ORDER BY "year") -1 ELSE NULL END AS yoy_1y_profit_years_in_row
    , CASE WHEN yoy_2_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY grp2 ORDER BY "year") -1 ELSE NULL END AS yoy_2y_profit_years_in_row
    , CASE WHEN yoy_3_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY grp3 ORDER BY "year") -1 ELSE NULL END AS yoy_3y_profit_years_in_row
    , CASE WHEN yoy_4_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY grp4 ORDER BY "year") -1 ELSE NULL END AS yoy_4y_profit_years_in_row
    , CASE WHEN yoy_5_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY grp5 ORDER BY "year") -1 ELSE NULL END AS yoy_5y_profit_years_in_row
    , CASE WHEN yoy_6_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY grp6 ORDER BY "year") -1 ELSE NULL END AS yoy_6y_profit_years_in_row
    , CASE WHEN yoy_7_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY grp7 ORDER BY "year") -1 ELSE NULL END AS yoy_7y_profit_years_in_row
    , CASE WHEN yoy_8_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY grp8 ORDER BY "year") -1 ELSE NULL END AS yoy_8y_profit_years_in_row
    , CASE WHEN yoy_9_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY grp9 ORDER BY "year") -1 ELSE NULL END AS yoy_9y_profit_years_in_row
    , CASE WHEN yoy_10_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY grp10 ORDER BY "year") -1 ELSE NULL END AS yoy_10y_profit_years_in_row
    , CASE WHEN yoy_11_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY grp11 ORDER BY "year") -1 ELSE NULL END AS yoy_11y_profit_years_in_row
    , CASE WHEN yoy_12_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY grp12 ORDER BY "year") -1 ELSE NULL END AS yoy_12y_profit_years_in_row
    , CASE WHEN yoy_13_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY grp13 ORDER BY "year") -1 ELSE NULL END AS yoy_13y_profit_years_in_row
    , CASE WHEN yoy_14_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY grp14 ORDER BY "year") -1 ELSE NULL END AS yoy_14y_profit_years_in_row
    , CASE WHEN yoy_15_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY grp15 ORDER BY "year") -1 ELSE NULL END AS yoy_15y_profit_years_in_row
    , CASE WHEN real_yoy_1_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY real_grp1 ORDER BY "year") -1 ELSE NULL END AS real_yoy_1y_profit_years_in_row
    , CASE WHEN real_yoy_2_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY real_grp2 ORDER BY "year") -1 ELSE NULL END AS real_yoy_2y_profit_years_in_row
    , CASE WHEN real_yoy_3_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY real_grp3 ORDER BY "year") -1 ELSE NULL END AS real_yoy_3y_profit_years_in_row
    , CASE WHEN real_yoy_4_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY real_grp4 ORDER BY "year") -1 ELSE NULL END AS real_yoy_4y_profit_years_in_row
    , CASE WHEN real_yoy_5_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY real_grp5 ORDER BY "year") -1 ELSE NULL END AS real_yoy_5y_profit_years_in_row
    , CASE WHEN real_yoy_6_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY real_grp6 ORDER BY "year") -1 ELSE NULL END AS real_yoy_6y_profit_years_in_row
    , CASE WHEN real_yoy_7_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY real_grp7 ORDER BY "year") -1 ELSE NULL END AS real_yoy_7y_profit_years_in_row
    , CASE WHEN real_yoy_8_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY real_grp8 ORDER BY "year") -1 ELSE NULL END AS real_yoy_8y_profit_years_in_row
    , CASE WHEN real_yoy_9_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY real_grp9 ORDER BY "year") -1 ELSE NULL END AS real_yoy_9y_profit_years_in_row
    , CASE WHEN real_yoy_10_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY real_grp10 ORDER BY "year") -1 ELSE NULL END AS real_yoy_10y_profit_years_in_row
    , CASE WHEN real_yoy_11_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY real_grp11 ORDER BY "year") -1 ELSE NULL END AS real_yoy_11y_profit_years_in_row
    , CASE WHEN real_yoy_12_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY real_grp12 ORDER BY "year") -1 ELSE NULL END AS real_yoy_12y_profit_years_in_row
    , CASE WHEN real_yoy_13_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY real_grp13 ORDER BY "year") -1 ELSE NULL END AS real_yoy_13y_profit_years_in_row
    , CASE WHEN real_yoy_14_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY real_grp14 ORDER BY "year") -1 ELSE NULL END AS real_yoy_14y_profit_years_in_row
    , CASE WHEN real_yoy_15_profit_years = 1 THEN ROW_NUMBER() OVER (PARTITION BY real_grp15 ORDER BY "year") -1 ELSE NULL END AS real_yoy_15y_profit_years_in_row
FROM (
    SELECT
        *
        , SUM(CASE WHEN yoy_1_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS grp1
        , SUM(CASE WHEN yoy_2_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS grp2
        , SUM(CASE WHEN yoy_3_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS grp3
        , SUM(CASE WHEN yoy_4_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS grp4
        , SUM(CASE WHEN yoy_5_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS grp5
        , SUM(CASE WHEN yoy_6_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS grp6
        , SUM(CASE WHEN yoy_7_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS grp7
        , SUM(CASE WHEN yoy_8_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS grp8
        , SUM(CASE WHEN yoy_9_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS grp9
        , SUM(CASE WHEN yoy_10_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS grp10
        , SUM(CASE WHEN yoy_11_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS grp11
        , SUM(CASE WHEN yoy_12_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS grp12
        , SUM(CASE WHEN yoy_13_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS grp13
        , SUM(CASE WHEN yoy_14_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS grp14
        , SUM(CASE WHEN yoy_15_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS grp15
        , SUM(CASE WHEN real_yoy_1_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS real_grp1
        , SUM(CASE WHEN real_yoy_2_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS real_grp2
        , SUM(CASE WHEN real_yoy_3_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS real_grp3
        , SUM(CASE WHEN real_yoy_4_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS real_grp4
        , SUM(CASE WHEN real_yoy_5_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS real_grp5
        , SUM(CASE WHEN real_yoy_6_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS real_grp6
        , SUM(CASE WHEN real_yoy_7_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS real_grp7
        , SUM(CASE WHEN real_yoy_8_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS real_grp8
        , SUM(CASE WHEN real_yoy_9_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS real_grp9
        , SUM(CASE WHEN real_yoy_10_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS real_grp10
        , SUM(CASE WHEN real_yoy_11_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS real_grp11
        , SUM(CASE WHEN real_yoy_12_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS real_grp12
        , SUM(CASE WHEN real_yoy_13_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS real_grp13
        , SUM(CASE WHEN real_yoy_14_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS real_grp14
        , SUM(CASE WHEN real_yoy_15_profit_years = 0 THEN 1 ELSE 0 END) OVER (ORDER BY "year") AS real_grp15
    FROM
...
, yoy_14_avg
, yoy_15_avg
, cpi_avg -1 as cpi_avg
, cpi_2y_avg -1 as cpi_2y_avg
, cpi_3y_avg -1 as cpi_3y_avg
, cpi_4y_avg -1 as cpi_4y_avg
, cpi_5y_avg -1 as cpi_5y_avg
, cpi_6y_avg -1 as cpi_6y_avg
, cpi_7y_avg -1 as cpi_7y_avg
, cpi_8y_avg -1 as cpi_8y_avg
, cpi_9y_avg -1 as cpi_9y_avg
, cpi_10y_avg -1 as cpi_10y_avg
, cpi_11y_avg -1 as cpi_11y_avg
, cpi_12y_avg -1 as cpi_12y_avg
, cpi_13y_avg -1 as cpi_13y_avg
, cpi_14y_avg -1 as cpi_14y_avg
, cpi_15y_avg -1 as cpi_15y_avg
, yoy_1_profit_years
, yoy_2_profit_years
, yoy_3_profit_years
, yoy_4_profit_years
